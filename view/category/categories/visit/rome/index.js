...
module.exports = [
  {
    title: "historical",
    image_url: "https://api.marco-app.com/api/image/HistoricalRome.jpg",
  ...
  {
    title: "mustSee",
    image_url: "https://api.marco-app.com/api/image/MustseeRome.jpg",
    subtitle: "mustSeeSub",
    buttons: [
      {
        type: "postback",
  ...
  {
    title: "cultural",
    image_url: "https://api.marco-app.com/api/image/CulturalRome.jpg",
  ...
  {
    title: "other",
    image_url: "https://api.marco-app.com/api/image/OtherRome.jpg",
    subtitle: "otherSub",
    buttons: [
      {
        type: "postback",
